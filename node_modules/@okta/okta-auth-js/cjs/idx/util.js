...
function getAvailableSteps(authClient, idxResponse, useGenericRemediator) {
  ...
  for (const [name] of (0, _entries.default)(idxResponse.actions || {})) {
    ...
    if ((0, _startsWith.default)(name).call(name, 'currentAuthenticator')) {
      ...
      const value = (_actionObj$value = actionObj.value) === null || _actionObj$value === void 0 ? void 0 : (0, _filter.default)(_actionObj$value).call(_actionObj$value, item => item.name !== 'stateHandle');
      stepObj = { ...rest,
        ...(value && {
          value
        }),
